...
![2b729c27-7a5a-4a05-86df-b9d7cdf6e741](/DragonLab/images/2b729c27-7a5a-4a05-86df-b9d7cdf6e741.png)

![f23991ca-4887-4f36-a4bb-0f749444cba9](/DragonLab/images/f23991ca-4887-4f36-a4bb-0f749444cba9.png)
...
技术报告是Agent生成的（吐舌），大部分中间的标准流程已经归档。这毕竟是第二个数据集。我打算先研究一下现在的Mk2，然后再考虑multi-model、卷R²的事情。应该说DS其实也是很有趣的一件事。那就继续做下去吧😎
...
##### S :做500次循环alpha拟合找最好的alpha值，发现是0.009；顺便也把Ratio暴力破一下，0.47（大规模数据就直接梯度下降或者二分，就别暴力了）

最后表现：

##### R²=0.8605 ± 0.0565

实际上，一开始提出的热力图/交叉验证/非线性建模，被证明是,在ML神力下，老手工艺人真还是算了（。设计良好的Boosting模型能够学习到类似的细节特征，人的作用……
不知道，长大后再学习（
